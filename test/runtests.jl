...
# !!! Main.UserApp is configured as an alias for Main.Proteus and you might encounter it in some tests
using Main.Proteus, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Proteus tests" begin
  @includetests ARGS
end
